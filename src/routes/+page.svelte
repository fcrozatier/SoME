	...
	const phases = [
		{
			...
			description:
				'Participants all work on their projects. The <a href="https://discord.gg/WZvZMVsXXR" target="_blank">Discord</a> server allows creators to share partial progress, find collaborators and ask for help.',
