...
<article class="layout-prose">
	<section id="rules" class="layout-prose pb-32">
		...
		<details>
			...
			<ul>
				<li>
					<b>Motivation:</b> It should be clear early on in the explainer why the topic matters and why someone should be excited to learn about it.
				</li>
				<li>
					<b> Clarity: </b> Jargon should be explained, the goals of the lesson should be easy to understand for someone in the targeted audience, and the presentation should show care for people who might
					be new to the topic.
				</li>
				<li>
